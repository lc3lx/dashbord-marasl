...
export async function GET(request: NextRequest) {
  ...
  const url = `${API_BASE_URL}/admin/invoices?${searchParams.toString()}`
  ...
  try {
    ...
    console.error("[v0] Invoices API Error:", error.message)
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    console.error("[v0] Create Invoice Error:", error.message)
...
export async function PUT(request: NextRequest) {
  ...
  const url = `${API_BASE_URL}/admin/invoices/${id}`
  ...
  try {
    ...
    console.error("[v0] Update Invoice Error:", error.message)
...
export async function DELETE(request: NextRequest) {
  ...
  try {
    ...
    console.error("[v0] Delete Invoice Error:", error.message)
