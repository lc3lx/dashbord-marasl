...
export async function GET(request: NextRequest) {
  ...
  const url = `${API_BASE_URL}/admin/coupons?${searchParams.toString()}`
  ...
  try {
    ...
    if (!response.ok) {
      const errorData = await response.json().catch(() => ({ message: "Failed to fetch coupons" }))
    ...
    console.error("[v0] Coupons API Error:", error.message)
...
export async function POST(request: NextRequest) {
  ...
  const url = `${API_BASE_URL}/admin/coupons`
  ...
  try {
    ...
    if (!response.ok) {
      const errorData = await response.json().catch(() => ({ message: "Failed to create coupon" }))
      return NextResponse.json(errorData, { status: response.status })
    }
    ...
    console.error("[v0] Create Coupon Error:", error.message)
...
export async function PUT(request: NextRequest) {
  ...
  const url = `${API_BASE_URL}/admin/coupons/${id}`
  ...
  try {
    ...
    if (!response.ok) {
      const errorData = await response.json().catch(() => ({ message: "Failed to update coupon" }))
      return NextResponse.json(errorData, { status: response.status })
    }
    ...
    console.error("[v0] Update Coupon Error:", error.message)
...
export async function DELETE(request: NextRequest) {
  ...
  try {
    ...
    if (!response.ok) {
      const errorData = await response.json().catch(() => ({ message: "Failed to delete coupon" }))
      return NextResponse.json(errorData, { status: response.status })
    }
    ...
    console.error("[v0] Delete Coupon Error:", error.message)
